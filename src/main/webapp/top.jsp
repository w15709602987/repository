...
<head>
    ...
    <title>top</title>
    <link href="/testSSMStepByStep/skin/css/base.css" rel="stylesheet" type="text/css">
    <script>
        var preFrameW = '206,*';
        var FrameHide = 0;
        var curStyle = 1;
    ...
    <style>
        ...
        {
            text-align:center;
            background:url('/testSSMStepByStep/skin/images/frame/topitembg.gif') 0px 3px no-repeat;
            width:82px;
            height:26px;
            line-height:28px;
        }
...
<body bgColor='#ffffff'>
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="/testSSMStepByStep/skin/images/frame/topbg.gif">
    <tr>
        <td width='20%' height="60"><img src="/testSSMStepByStep/skin/images/frame/logo.gif" /></td>
        <td width='80%' align="right" valign="bottom">
            <table width="750" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="right" height="26" style="padding-right:10px;line-height:26px;">
                        您好：<span class="username" ><font color="red">${sessionScope.user.username}</font></span>，欢迎使用项目平台管理系统！

                        [<a href="indexTest.jsp" target="_top">主页</a>]
                        [<a href="modpassword.jsp"  target="main">修改密码</a>]
                        [<a href="javascript:void(0);" onClick="parent.location.href='/testSSMStepByStep/login.jsp'" target="_login">注销退出</a>]&nbsp;
                    </td>
                </tr>
                <tr>
