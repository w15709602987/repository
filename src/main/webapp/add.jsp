...
<script>
    ...
    function validateForm() {
        ...
        var addm = document.getElementById("addm").value;
        if (addm.match("^[0-9]*$")== null||addm == "") {
            alert("导入次数仅能输入数字！");
            return false;
        }
...
<form name="form2" method="post" action="/testSSMStepByStep/addmany.do" onsubmit="return validateForm();">
    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
        ...
        <tr >
            <td align="right" bgcolor="#FAFAF1" >导入数量：</td>
            <td colspan=3 align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" >
                <input type="text" name="addm" id="addm"/></textarea>
            </td>
        </tr>
